...
export default function Home() {
  const title = 'Pivacy | Pixy';
  const description = 'The best app to identify mood patterns for people facing struggles with mental health.';
    ...
    <div className="">
      ...
      <main className="max-w-3xl my-20 px-4 mx-auto prose">
          ...
          <p>
            ...
            Terms and Conditions, which are accessible at Pixy Mood Tracker unless
          ...
          <ul>
            ...
            <li>
              <a href="https://segment.io/">Segment</a>
            </li>
          </ul>
          <h3>Log Data</h3>
          <p>
          ...
          <p>
            ...
            not hesitate to contact me at <a href="mailto:care@pixy.day">care@pixy.day</a>.
          </p>
        </main>
      <Footer />
    </div>
