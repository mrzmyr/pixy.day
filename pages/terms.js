    ...
    <div className="">
      ...
      <main className="max-w-3xl my-20 px-4 mx-auto prose">
          ...
          <p>
            ...
            related to it, still belong to Moritz Meyer.
          </p>
          <p>
            Moritz Meyer is committed to ensuring that the app is as useful and
          ...
          <p>
            The Pixy Mood Tracker app stores and processes personal data that you
            ...
            phone’s security features and it could mean that the Pixy Mood Tracker
          ...
          <p>
            You should be aware that there are certain things that Moritz Meyer
            ...
            can be Wi-Fi or provided by your mobile network provider, but Moritz
            Meyer cannot take responsibility for the app not working at full
          ...
          <p>
            Along the same lines, Moritz Meyer cannot always take responsibility
            ...
            on to avail the Service, Moritz Meyer cannot accept responsibility.
          </p>
          <p>
            With respect to Moritz Meyer’s responsibility for your use of the app,
            ...
            that we can make it available to you. Moritz Meyer accepts no
          ...
          <p>
            ...
            the updates if you want to keep using the app. Moritz Meyer does not
          ...
          <p>
            ...
            <a href="mailto:hello@pixy.day">hello@pixy.day</a>.
          </p>
        </main>
      <Footer />
    </div>
